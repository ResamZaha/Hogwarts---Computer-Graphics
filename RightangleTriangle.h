...
public:
    ...
    RightAngleTriangle(float base = 1.0f, float height = 1.0f,
    ...
    void drawRightAngleTriangle(Shader& lightingShader, glm::mat4 model = glm::mat4(1.0f), float r = 1.0f, float g = 1.0f, float b = 1.0f) const
    {
        lightingShader.use();
