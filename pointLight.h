...
public:
    ...
    void setUpPointLight(Shader& lightingShader)
    {
        ...
        string key = "pointLights[" + to_string(lightNumber) + "]";
        lightingShader.setVec3(key + ".position", position);
        lightingShader.setVec3(key + ".ambient", ambientOn * ambient);
        lightingShader.setVec3(key + ".diffuse", diffuseOn * diffuse);
        lightingShader.setVec3(key + ".specular", specularOn * specular);
        lightingShader.setFloat(key + ".k_c", k_c);
        lightingShader.setFloat(key + ".k_l", k_l);
        lightingShader.setFloat(key + ".k_q", k_q);
    }
