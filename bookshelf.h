...
#include <random>
#include "cube.h"
void bookShelf(Cube& cube, Shader& lightingShader, glm::mat4 als, float colorArray[], unsigned int wood1, unsigned int wood2)
{
...
void bottleShelf(Cube& cube, Shader& lightingShader, glm::mat4 als, float colorArray[], int binaryArray[],unsigned int wood1, unsigned int wood2)
{

	glm::mat4 identityMatrix = glm::mat4(1.0f); // make sure to initialize matrix to identity matrix first
	glm::mat4 translateMatrix, rotateXMatrix, rotateYMatrix, rotateZMatrix, scaleMatrix, model, ttranslate, ytranslate, temp;
	...
	//bookshelf first rack
	translateMatrix = glm::translate(identityMatrix, glm::vec3(0.0, 1.2f, 0.0));
	scaleMatrix = glm::scale(identityMatrix, glm::vec3(3.0, .1, .5));
	model = als * translateMatrix * scaleMatrix;
	//drawCube(cubeVAO, lightingShader, model, 0.6, 0.3f, 0.125f);
	//cube.setMaterialisticEimu(0.6, 0.3f, 0.125f);
	...
	//bookshelf second rack
	translateMatrix = glm::translate(identityMatrix, glm::vec3(0.0, 1.2 + 1.1, 0.0));
	scaleMatrix = glm::scale(identityMatrix, glm::vec3(3.0, .1, .5));
	model = als * translateMatrix * scaleMatrix;
	//drawCube(cubeVAO, lightingShader, model, 0.6, 0.3f, 0.125f);
	//cube.setMaterialisticEimu(0.6, 0.3f, 0.125f);
	...
	//bookshelf third rack
	translateMatrix = glm::translate(identityMatrix, glm::vec3(0.0, 1.2 + 1.1 * 2, 0.0));
	scaleMatrix = glm::scale(identityMatrix, glm::vec3(3.0, .1, .5));
	model = als * translateMatrix * scaleMatrix;
	//drawCube(cubeVAO, lightingShader, model, 0.6, 0.3f, 0.125f);
	//cube.setMaterialisticEimu(0.6, 0.3f, 0.125f);
	...
	//bookshelf top
	translateMatrix = glm::translate(identityMatrix, glm::vec3(0.0, 1.2 + 1.1 * 3, 0.0));
	scaleMatrix = glm::scale(identityMatrix, glm::vec3(3.0, .2, .5));
	model = als * translateMatrix * scaleMatrix;
	//drawCube(cubeVAO, lightingShader, model, 0.6, 0.3f, 0.125f);
	//cube.setMaterialisticEimu(0.6, 0.3f, 0.125f);
	...
	//bookshelf left
	translateMatrix = glm::translate(identityMatrix, glm::vec3(0.0, 0.0, 0.0));
	scaleMatrix = glm::scale(identityMatrix, glm::vec3(.2, 5.0, .5));
	model = als * translateMatrix * scaleMatrix;
	//drawCube(cubeVAO, lightingShader, model, 0.6, 0.3f, 0.125f);
	//cube.setMaterialisticEimu(0.6, 0.3f, 0.125f);
	//cube.drawCubeWithMaterialisticProperty(lightingShader, model);
	...
	//bookshelf back
	translateMatrix = glm::translate(identityMatrix, glm::vec3(0.0, 0.0, 0.0));
	scaleMatrix = glm::scale(identityMatrix, glm::vec3(3.0, 5.0, .05));
	model = als * translateMatrix * scaleMatrix;
	//drawCube(cubeVAO, lightingShader, model, 0.6, 0.3f, 0.125f);
	//cube.setMaterialisticEimu(0.6, 0.3f, 0.125f);
	//cube.drawCubeWithMaterialisticProperty(lightingShader, model);
	...
	temp = als;
	{
		...
		{
			ytranslate = glm::translate(identityMatrix, glm::vec3(0.0f, 0.0 + j * 1.1, 0.0f));
			for (float i = 0.0; i < 7.0; i = i + 1.0)
			{
				...
				*/
				temp = als;
				translateMatrix = glm::translate(identityMatrix, glm::vec3(.45 + i * .4, 0.55f, 0.2f));
				als = als * translateMatrix;
				cylinder.drawCylinder(lightingShader, als * ytranslate, colorArray[index], colorArray[index + 1], colorArray[index + 2]);
				cube.setMaterialisticEimu(colorArray[index], colorArray[index + 1], colorArray[index + 2]);
				index = index + 3;
				als = temp;
				temp = als;
				translateMatrix = glm::translate(identityMatrix, glm::vec3(.45 + i * .4, .9, 0.2f));
				sphere.drawSphere(lightingShader, als * translateMatrix * ytranslate, 0.0f, 0.0f, 0.0f);
				als = temp;
			}
		}
		als = temp;
